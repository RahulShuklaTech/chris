...
const DeviceVariables = {
  USER_UUID_VAL: '-',
  USER_ONBOARDING_CHAT_COMPLETED: true,
  USER_JSON: [{}],
...
const AppVariables = {
  CHATBOT_APP_CHECK_MAIN: 'some CHATBOT_APP_CHECK_MAIN',
  TEMP_JSON: [],
  CHATBOT_URL_MAIN: 'some CHATBOT_URL_MAIN',
  CHATBOT_URL_ONBOARD: 'some CHATBOT_URL_ONBOARD',
  CHATBOT_APP_CHECK_ONBOARD: 'some CHATBOT_APP_CHECK_ONBOARD',
  AIRTABLE_API_KEY: 'some AIRTABLE_API_KEY',
  ERROR_MESSAGE: 'some ERROR_MESSAGE',
  SUPABASE_API_KEY_HEADER: 'some SUPABASE_API_KEY_HEADER',
};
